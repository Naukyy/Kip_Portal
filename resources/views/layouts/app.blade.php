...
<div class="flex h-full">
    {{-- Sidebar --}}
<aside class="hidden lg:flex lg:flex-col w-64 bg-white dark:bg-[#111827] border-r border-gray-200 dark:border-gray-800 flex-shrink-0 shadow-lg">
...
<aside x-show="sidebarOpen"
           class="fixed inset-y-0 left-0 w-64 bg-white dark:bg-[#111827] border-r border-gray-200 dark:border-gray-800 z-50 lg:hidden shadow-xl"
    ...
    <div class="flex-1 flex flex-col min-h-0 overflow-auto">
        {{-- Top navbar --}}
<header class="flex-shrink-0 h-16 bg-white dark:bg-[#111827] border-b border-gray-200 dark:border-gray-800 flex items-center px-4 lg:px-6 gap-4 shadow-lg">
